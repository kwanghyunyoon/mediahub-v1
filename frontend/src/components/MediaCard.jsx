...
const SourceBadge = ({ media, color }) => {
  ...
  return (
    <span
      ...
      className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] uppercase tracking-[0.15em] font-medium bg-white/[0.06] border border-white/[0.08] text-white/70"
      style={{ color }}
    >
    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 left-3">
          <SourceBadge media={media} color={accentColor} />
        </div>
        <div className="absolute bottom-3 right-3">
          <span className="w-8 h-8 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center text-white/70 group-hover:text-white border border-white/10 transition-colors">
